...
type SaBranch struct {
	...
	BaseDivID      int       `json:"base_div_id	" gorm:"type:varchar(60)"`
	BaseDeptID     int       `json:"base_dept_id	" gorm:"type:varchar(60)"`
	BaseCurrencyID int       `json:"base_currency_id	" gorm:"type:varchar(60)"`
